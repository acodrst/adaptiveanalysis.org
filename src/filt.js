...
const uris = {};
const bib = Deno.readTextFileSync("/home/divine/websites/site/ada/assets/My Library.bib");
for (
...
const link_image = {};
link_image.latex = ["tex", "\\includesvg[scale=.06]{/home/divine/websites/site/ada/assets/link.svg}"];
link_image.html5 = ["html", Deno.readTextFileSync("/home/divine/websites/site/ada/assets/link.svg").trim()];
for (const b in input.blocks) {
  ...
  if (input.blocks[b].t == "Figure") {
    ...
    const fig_txt = Deno.readTextFileSync(`/home/divine/websites/site/ada/images/${fig_img}`);
    ...
    if (format == "latex") {
      ...
      input.blocks[b] = {
        ...
        "c": [
          ...
          \\includesvg[scale=${s}]{/home/divine/websites/site/ada/images/${fig_img}}\\caption{${caption}}\\label{${label}}\\end{wrapfigure}`,
        ],
      };
    }
    }
    if (format == "html5") {
      ...
      const t = Deno.readTextFileSync(`/home/divine/websites/site/ada/images/${fig_img}`);
      input.blocks[b] = {
        "t": "RawBlock",
        "c": [
          "html",
